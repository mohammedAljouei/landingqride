...
export default function FeaturesPlanet() {
  return (
    <section style={{backgroundColor: "#fff"}} className="relative before:absolute before:inset-0 before:-z-20 before:bg-gray-900">
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl"
              ...
              dir="rtl"
            >
            طلبات السيارات الحين صارت أسهل وأسرع مع نظامنا  <span  style={{ fontFamily: 'CustomFont', color: "#6E6EFF" }}> الرهيب! </span> 
            </h2>
          </div>
          {/* Planet */}
 
          {/* Grid */}
          <div dir="rtl" className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-3 font-medium text-gray-200">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"><path fill="#6E6EFF" d="M14.29 2.614a1 1 0 0 0-1.58-1.228L6.407 9.492l-3.199-3.2a1 1 0 1 0-1.414 1.415l4 4a1 1 0 0 0 1.496-.093l7-9ZM1 14a1 1 0 1 0 0 2h14a1 1 0 1 0 0-2H1Z"></path></svg>

                <span></span>
                <span  style={{ fontFamily: 'CustomFont' , color: "#020944"}}>سهولة التثبيت والاستخدام للعملاء</span>
              </h3>
            ...
            <article>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"><path fill="#6E6EFF" d="M14.29 2.614a1 1 0 0 0-1.58-1.228L6.407 9.492l-3.199-3.2a1 1 0 1 0-1.414 1.415l4 4a1 1 0 0 0 1.496-.093l7-9ZM1 14a1 1 0 1 0 0 2h14a1 1 0 1 0 0-2H1Z"></path></svg>
                ...
                <span></span>
                <span   style={{ fontFamily: 'CustomFont' , color: "#020944"}}>تخصيص الألوان، القائمة، وسائل الدفع والتواصل بسهولة عالية جدا من قبل مالك المتجر</span>
              </h3>
            ...
            <article>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"><path fill="#6E6EFF" d="M14.29 2.614a1 1 0 0 0-1.58-1.228L6.407 9.492l-3.199-3.2a1 1 0 1 0-1.414 1.415l4 4a1 1 0 0 0 1.496-.093l7-9ZM1 14a1 1 0 1 0 0 2h14a1 1 0 1 0 0-2H1Z"></path></svg>
                ...
                <span></span>
                <span   style={{ fontFamily: 'CustomFont' , color: "#020944"}}>دعم فني متواصل على مدار الساعة</span>
              </h3>
